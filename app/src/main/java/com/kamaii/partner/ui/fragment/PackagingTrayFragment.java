...
import com.kamaii.partner.databinding.FragmentPackagingTrayBinding;
...
public class PackagingTrayFragment extends Fragment {

    FragmentPackagingTrayBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_packaging_tray, container, false);

        prefrence = SharedPrefrence.getInstance(getActivity());
        firebase = getActivity().getSharedPreferences("MyPrefs", MODE_PRIVATE);
        userDTO = prefrence.getParentUser(Consts.USER_DTO);
        baseActivity.headerNameTV.setText("Packaging Material");
    ...
    private void getOrders(int c) {
        ...
        Call<ResponseBody> callone = api.packageing_order_summary(userDTO.getUser_id(),String.valueOf(c));
